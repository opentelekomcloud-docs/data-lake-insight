...
.. table:: **Table 1** Procedure for using DLI to submit a SQL job to query OBS data
   ...
   +----------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Step 2: Create an Elastic Resource Pool and Create Queues Within It <dli_01_0002__section1573781010172>` | Create compute resources required for submitting jobs.                                                                                                      |
   +----------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
#. Create a bucket. In this example, the bucket name is **obs1**.
   ...
   b. On the displayed **Create Bucket** page, set **Bucket Name**. Retain the default values for other parameters or adjust them as needed.
...
#. In the navigation pane on the left of the DLI management console, choose **SQL Editor**.
