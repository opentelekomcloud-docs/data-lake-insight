...
.. table:: **Table 1** Procedure for using DLI to submit a SQL job to query RDS for MySQL data
   ...
   +----------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Step 3: Create an Elastic Resource Pool and Create Queues Within It <dli_01_0020__section1573781010172>` | Create compute resources required for submitting jobs.                                                                           |
   +----------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
...
#. On the **Buy DB Instance** page, set instance parameters, and click **Buy**.
   ...
   .. table:: **Table 2** RDS for MySQL instance parameters
      ...
      +------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------+
      | Database Port          | The default port is **3306**. You can change it after the DB instance is created.                                                                                                                                                                                                                                                         | 3306                      |
      |                        |                                                                                                                                                                                                                                                                                                                                           |                           |
...
#. Set the basic parameters listed below.
   ...
   .. table:: **Table 4** Basic parameters for adding a queue
      ...
      +-----------------------+--------------------------------------------------------------------+------------------------------------------------------+
      | Type                  | Type of the queue                                                  | For SQL jobs, select **For SQL**.                    |
      |                       |                                                                    |                                                      |
      |                       | -  To execute SQL jobs, select **For SQL**.                        | For other scenarios, select **For general purpose**. |
...
#. Create an enhanced datasource connection between RDS for MySQL and DLI.
   ...
   b. On the displayed **Enhanced** tab, click **Create**. Set the following parameters:
      ...
      -  **Resource Pool**: Select the elastic resource pool created in :ref:`Step 3: Create an Elastic Resource Pool and Create Queues Within It <dli_01_0020__section1573781010172>`.
   ...
   e. Test if the queue can connect to the RDS for MySQL DB instance.
      ...
      #. In the navigation pane on the left, choose **Resources** > **Queue Management**. On the displayed page, locate the queue added in :ref:`Step 3: Create an Elastic Resource Pool and Create Queues Within It <dli_01_0020__section1573781010172>`, click **More** in the **Operation** column, and select **Test Address Connectivity**.
