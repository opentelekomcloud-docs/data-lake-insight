...
3. Configure the application.
   ...
   .. table:: **Table 1** Application configuration parameters
      ...
      +-----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Agency                            | Before using Spark 3.3.1 or later (Spark general queue scenario) to run jobs, you need to create an agency on the IAM console and add the new agency information. For details, see :ref:`Customizing DLI Agency Permissions <dli_01_0616>`.                                         |
      |                                   |                                                                                                                                                                                                                                                                                     |
...
4. Configure the job.
   ...
   .. table:: **Table 2** Job configuration parameters
      ...
      |                                   |    -  If the Spark version is **3.1.1**, configure **Spark parameters (--conf)** to select a dependency module. For details about the example configuration, see :ref:`Table 3 <dli_01_0384__table17326112613420>`.                                                                                           |
      |                                   |                                                                                                                                                                                                                                                                                                               |
      ...
      |                                   |                                                                                                                                                                                                                                                                                                               |
      |                                   | :ref:`Table 4 <dli_01_0384__table1434294918228>` describes the parameter mapping.                                                                                                                                                                                                                             |
      |                                   |                                                                                                                                                                                                                                                                                                               |
      |                                   | .. note::                                                                                                                                                                                                                                                                                                     |
      |                                   |                                                                                                                                                                                                                                                                                                               |
      ...
      +-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Access Metadata                   | Choose whether to enable access to metadata for a Spark job. Set it to **Yes** if you need to configure the metadata type accessed by the job. DLI metadata is accessed by default.                                                                                                                           |
      |                                   |                                                                                                                                                                                                                                                                                                               |
   ...
   .. table:: **Table 3** Spark Parameter (--conf) configuration
   ...
   .. _dli_01_0384__table1434294918228:

   .. table:: **Table 4** Mapping between compute resource specification parameters on the console and Spark Argument(--conf)

      +----------------------------------------------------------------------------------+---------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Console Parameter                                                                | Spark Argument(--conf)                | Description                                                                                                                                                                                                                                      | Notes and Constraints                                                                                                                                                                                       |
      +==================================================================================+=======================================+==================================================================================================================================================================================================================================================+=============================================================================================================================================================================================================+
      | Executor Memory                                                                  | spark.executor.memory                 | Executor memory, which is configurable.                                                                                                                                                                                                          | ``-``                                                                                                                                                                                                       |
      |                                                                                  |                                       |                                                                                                                                                                                                                                                  |                                                                                                                                                                                                             |
      | Complete executor memory = spark.executor.memory + spark.executor.memoryOverhead |                                       |                                                                                                                                                                                                                                                  |                                                                                                                                                                                                             |
      +----------------------------------------------------------------------------------+---------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      |                                                                                  | spark.executor.memoryOverhead         | Amount of off-heap memory for each executor in a Spark application. This parameter is not configurable.                                                                                                                                          | The minimum value is 384 MB.                                                                                                                                                                                |
      |                                                                                  |                                       |                                                                                                                                                                                                                                                  |                                                                                                                                                                                                             |
      |                                                                                  |                                       | spark.executor.memoryOverhead=spark.executor.memory \* spark.executor.memoryOverheadFactor                                                                                                                                                       | That is, when the value of **spark.executor.memory** multiplied by **spark.executor.memoryOverheadFactor** is less than 384 MB, the system automatically sets the value to 384 MB.                          |
      +----------------------------------------------------------------------------------+---------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      ...
      +----------------------------------------------------------------------------------+---------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Driver Memory                                                                    | spark.driver.memory                   | Driver memory, which is configurable.                                                                                                                                                                                                            | ``-``                                                                                                                                                                                                       |
      |                                                                                  |                                       |                                                                                                                                                                                                                                                  |                                                                                                                                                                                                             |
      | Complete driver memory = spark.driver.memory + spark.edriver.memoryOverhead      |                                       |                                                                                                                                                                                                                                                  |                                                                                                                                                                                                             |
      +----------------------------------------------------------------------------------+---------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      |                                                                                  | spark.driver.memoryOverhead           | Amount of off-heap memory for each driver in a Spark application.                                                                                                                                                                                | The minimum value is 384 MB. That is, when the value of **spark.driver.memory** multiplied by **spark.driver.memoryOverheadFactor** is less than 384 MB, the system automatically sets the value to 384 MB. |
      |                                                                                  |                                       |                                                                                                                                                                                                                                                  |                                                                                                                                                                                                             |
...
5. (Optional) Configure dependencies.
   ...
   .. table:: **Table 5** Dependency configuration parameters
...
6. Set the following parameters in advanced settings:
   ...
   -  **Select Dependency Resources**: For details about the parameters, see :ref:`Table 6 <dli_01_0384__table6886411195318>`.
   -  **Configure Resources**: For details about the parameters, see :ref:`Table 7 <dli_01_0384__table388781175311>`.
   ...
   .. table:: **Table 6** Parameters for selecting dependency resources
   ...
   .. table:: **Table 7** Resource specification parameters
   ...
   -  Spark 3.3.1 or later includes notes and constraints on the compute resource specifications for jobs. For details, see :ref:`Table 8 <dli_01_0384__table2022325542315>`.
      ...
      .. _dli_01_0384__table2022325542315:

      .. table:: **Table 8** Value ranges of compute resources specifications
...
7. Click **Execute** in the upper right corner of the Spark job editing page.
   ...
   .. note::
      ...
      During the Spark job submission process, if the job fails to acquire resources successfully for an extended period, the job status will change to **Failed** after waiting for approximately 3 hours, indicating that the session has exited. For details about Spark job statuses, see :ref:`Viewing Basic Information <dli_01_0385__section12526165519235>`.
