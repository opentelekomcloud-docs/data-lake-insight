:original_name: dli_03_0206.html
...
-  :ref:`Why Am I Seeing the Error Message "The current account does not have permission to perform this operation,the current account was restricted. Restricted for no budget" When Executing a SQL Statement? <dli_03_0210>`
...
.. toctree::
   ...
   why_is_error_dli.0001_org.apache.hadoop.security.accesscontrolexception_verifybucketexists_on_bucket_name_status_[403]_reported_when_i_access_a_sql_job
   why_am_i_seeing_the_error_message_the_current_account_does_not_have_permission_to_perform_this_operationthe_current_account_was_restricted._restricted_for_no_budget_when_executing_a_sql_statement
