...
.. table:: **Table 2** Request parameter
   ...
   | Parameter              | Mandatory       | Type             | Description                                                                                                                                                                |
   +========================+=================+==================+============================================================================================================================================================================+
   | queue_scaling_policies | Yes             | Array of objects | Scaling policy of a queue in an elastic resource pool. A policy contains the period, priority, and CU range.                                                               |
   |                        |                 |                  |                                                                                                                                                                            |
   |                        |                 |                  | There must be a default scaling policy (period [00:00, 24:00]) for each queue. For details about the parameters, see :ref:`Table 3 <dli_02_0332__request_priority_infos>`. |
   +------------------------+-----------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
