...
-  Parameter description
   ...
   .. table:: **Table 1** URI parameters
      ...
      +------------+-----------+--------+---------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | plan_id    | Yes       | Long   | ID of scheduled CU change to be deleted. For details about how to obtain the IDs, see :ref:`Viewing a Scheduled CU Change (Discarded) <dli_02_0292>`.         |
      +------------+-----------+--------+---------------------------------------------------------------------------------------------------------------------------------------------------------------+
